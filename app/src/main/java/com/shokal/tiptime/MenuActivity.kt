...
class MenuActivity : AppCompatActivity() {
    ...
    //private lateinit var defaultSet: ArrayList<String>
...
//            val gson = Gson()
//            val json = sharedPreferences.getString("totalAmounts",null)
//            val type : Type = object: TypeToken<ArrayList<String>>(){}.type
//            Log.d("cache", gson.fromJson<String?>(json, type).toString())
//        }catch (e: Error){
...
//        }
        ...
        binding.personDown.setOnClickListener {
            ...
            if (numberPerson == null) {
                ...
                Toast.makeText(
                    this,
                    "Order Can not be placed for less than one Person",
                    Toast.LENGTH_SHORT
                ).show()
            }
        }
        binding.paybtn.setOnClickListener {
            if (totalAmount > 1) {
                ...
                Toast.makeText(this, "You can not continue without purchase", Toast.LENGTH_SHORT)
                    .show()
            }
        }
    }
